...
%
% Answer: x = anoval(y)
% Runs a one-way anova of data 

% 8. What are the 2 major types of loops that MATLAB supports? What is the
% difference between them?

%
% Answer: loop goes as long as the condition remains true. loop goes for a
% specific number of times, keeps track of each iteration with incrementing
% index variable. "For" loop and "While" loop.
% 
